...
func Cors() gin.HandlerFunc {
	return func(context *gin.Context) {
		...
		if origin != "" {
			...
			context.Header("Access-Control-Allow-Headers", "Authorization, Content-Length, Token,session,X_Requested_With,Accept, Origin, Host, User-Agent, X-Requested-With, Content-Type")
